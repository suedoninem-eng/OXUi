    ...
    >
      ...
      >
        <RevealBackground 
          ...
          radius={window.innerWidth < 1024 ? 80 : 120}
          hardness={5}
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
        <div style={{ marginBottom: '20px', position: 'relative', zIndex: 1, transition: 'transform 0.3s ease' }} 
             onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.1)'}
             onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src={logoSrc} alt="OXUI Logo" style={{ height: 'clamp(30px, 8vw, 40px)', width: 'auto', filter: 'drop-shadow(0 0 10px rgba(255,255,255,0.3))' }} />
          </div>
        </div>
        
        <div style={{ textAlign: 'center', maxWidth: '800px', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <h1 ref={title1Ref} style={{ fontSize: 'clamp(2rem, 10vw, 6rem)', fontWeight: 700, lineHeight: 0.9, fontFamily: "'Syncopate', sans-serif", letterSpacing: '-0.05em' }}>
            EXPERIENCE
          </h1>
          <h1 ref={title2Ref} style={{ fontSize: 'clamp(2rem, 10vw, 6rem)', fontWeight: 400, color: 'rgba(255,255,255,0.4)', lineHeight: 0.9, fontFamily: "'Syncopate', sans-serif", letterSpacing: '-0.05em', marginBottom: '20px' }}>
            THE FUTURE
          </h1>
